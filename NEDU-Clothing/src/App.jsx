  ...
  <div className="min-h-screen flex flex-col">
    ...
    <h2 className="text-3xl font-bold mb-8 text-center text-black">Productos Destacados</h2>
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
        <ProductCard name="Sudadera Cerezas" price={39.99} imageUrl="/assets/product1.png" />
        <ProductCard name="Camiseta Chad" price={19.99} imageUrl="/assets/product2.png" />
        <ProductCard name="Top sin mangas" price={17.95} imageUrl="/assets/product3.png" />
        <ProductCard name="Jersey Chill" price={29.99} imageUrl="/assets/product5.png" />
      </div>
    </div>
